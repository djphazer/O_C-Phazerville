...
#define HEMISPHERE_CLOCK_TICKS (1000 / OC_CORE_TIMER_RATE) // one millisecond
#define HEMISPHERE_CURSOR_TICKS (300 * HEMISPHERE_CLOCK_TICKS)
#define HEMISPHERE_ADC_LAG (HEMISPHERE_CLOCK_TICKS*2)
